...
// Test message for holding special primitives.
type Specials struct {
	ONan             *float32 `protobuf:"fixed32,1,opt,name=o_nan,json=oNan" json:"o_nan,omitempty"`
	OPinf            *float32 `protobuf:"fixed32,2,opt,name=o_pinf,json=oPinf" json:"o_pinf,omitempty"`
	ONinf            *float32 `protobuf:"fixed32,3,opt,name=o_ninf,json=oNinf" json:"o_ninf,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *Specials) Reset()                    { *m = Specials{} }
func (m *Specials) String() string            { return proto.CompactTextString(m) }
func (*Specials) ProtoMessage()               {}
func (*Specials) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{1} }

func (m *Specials) GetONan() float32 {
	if m != nil && m.ONan != nil {
		return *m.ONan
	}
	return 0
...
func (m *Specials) GetOPinf() float32 {
	if m != nil && m.OPinf != nil {
		return *m.OPinf
	}
	return 0
}

func (m *Specials) GetONinf() float32 {
	if m != nil && m.ONinf != nil {
		return *m.ONinf
	}
	return 0
}
...
func init() {
	...
	proto.RegisterType((*Specials)(nil), "jsonpb.Specials")
...
var fileDescriptor1 = []byte{
	...
	,
}
