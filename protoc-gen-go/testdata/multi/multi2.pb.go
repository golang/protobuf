...
func (Multi2_Color) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_multi2_bb3c2849fa14029b, []int{0, 0}
}
...
func (*Multi2) Descriptor() ([]byte, []int) {
	return fileDescriptor_multi2_bb3c2849fa14029b, []int{0}
}
...
func init() { proto.RegisterFile("multi/multi2.proto", fileDescriptor_multi2_bb3c2849fa14029b) }

var fileDescriptor_multi2_bb3c2849fa14029b = []byte{
